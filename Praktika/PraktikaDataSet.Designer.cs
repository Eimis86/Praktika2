...
namespace Praktika {
    ...
    public partial class PraktikaDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsersRow AddUsersRow(string Firstname, string Surname, string Username, string Password, string Role) {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([ID] = @Original_ID) AND ([Firstname] = @Origin" +
                "al_Firstname) AND ([Surname] = @Original_Surname) AND ([Username] = @Original_Us" +
                "ername) AND ([Password] = @Original_Password) AND ([Role] = @Original_Role))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([Firstname], [Surname], [Username], [Password], [Role]" +
                ") VALUES (@Firstname, @Surname, @Username, @Password, @Role);\r\nSELECT ID, Firstn" +
                "ame, Surname, Username, Password, Role FROM Users WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [Firstname] = @Firstname, [Surname] = @Surname, [Username] = @Username, [Password] = @Password, [Role] = @Role WHERE (([ID] = @Original_ID) AND ([Firstname] = @Original_Firstname) AND ([Surname] = @Original_Surname) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ([Role] = @Original_Role));
SELECT ID, Firstname, Surname, Username, Password, Role FROM Users WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Firstname, Surname, Username, Password, Role FROM dbo.Users";
        ...
        public virtual int Delete(int Original_ID, string Original_Firstname, string Original_Surname, string Original_Username, string Original_Password, string Original_Role) {
        ...
        public virtual int Insert(string Firstname, string Surname, string Username, string Password, string Role) {
            if ((Firstname == null)) {
        ...
        public virtual int Update(string Firstname, string Surname, string Username, string Password, string Role, int Original_ID, string Original_Firstname, string Original_Surname, string Original_Username, string Original_Password, string Original_Role, int ID) {
            if ((Firstname == null)) {
                throw new global::System.ArgumentNullException("Firstname");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Firstname, string Surname, string Username, string Password, string Role, int Original_ID, string Original_Firstname, string Original_Surname, string Original_Username, string Original_Password, string Original_Role) {
            return this.Update(Firstname, Surname, Username, Password, Role, Original_ID, Original_Firstname, Original_Surname, Original_Username, Original_Password, Original_Role, Original_ID);
        }
    }
